...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const contactHeaderHeight = document.querySelector('.contact-header').offsetHeight;
      ...
      <header className="contact-header bg-teal-500 text-white p-2">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center">
            ...
            <a href="https://www.instagram.com/tuperfil" target="_blank" className="text-white mx-2">
